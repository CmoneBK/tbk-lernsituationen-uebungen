...
| `test-drehprozess.js` | Das ganze Paket zum Drehprozess: stimmen Schnittdaten, Bedingungen und Zugfestigkeiten mit dem Tabellenbuch überein, nehmen die sechs Trainings die Buchantwort an, rechnen die vier Übungen und die Lernsituation denselben Weg — und ist der Zeichenbaustein in beiden Repos derselbe? |
